...
from chat.models import MessageModel, Room, UserModel, UploadedFile
...
@database_sync_to_async
def get_unread_count(sender, receiver) -> Awaitable[int]:
    return int(MessageModel.get_unread_count_for_dialog_with_user(sender, receiver))
